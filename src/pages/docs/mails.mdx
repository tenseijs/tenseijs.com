...
Tensei ships with plugins to send emails using [AWS SES](https://aws.amazon.com/ses/), SMTP, [Sparkpost](https://sparkpost.com), [Mailgun](https://mailgun.com) and [Sendgrid](https://sendgrid.com).
...
### SMTP
You may use the `smpt` plugin to add support for smtp. Let's take an example on how to use [mailtrap](https://mailtrap.com) smtp:
